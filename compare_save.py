...
bndf = pd.melt(bndf, id_vars=(['Author', 'Title', 'Edition', 'Publisher', 'Imprint', 'Course', 'Section', 'Professor', 'Course Capacity', 'Actual Enrollment']), value_vars=keys, value_name='ISBN')
